...
-- user defined
browser    = "chromium --high-dpi-support=1 --disk-cache-dir=/dev/shm/chromium_cache"
--browser2   = "iron"
--gui_editor = "gvim"
graphics   = "gimp"
...
for s = 1, screen.count() do
	...
	awful.tag.setmwfact (0.15, tags[s][5])
end
-- }}}
...
-- Flightmode
--flightmode_icon = wibox.widget.textbox('<span color="#90EE90"></span><span color="#78A4FF" font="Terminus 9.5"> Flightmode</span>')
...
mpdwidget = lain.widgets.mpd({
    settings = function ()
        if mpd_now.state == "play" then
            ...
            widget:set_markup(markup.font("Terminus 10", " ")
                              .. markup.font("Terminus 10",
                              mpd_now.artist
                              .. " - " ..
                              mpd_now.title
                              .. markup.font("Terminus 10", " ")))
            play_pause_icon:set_text('')
        elseif mpd_now.state == "pause" then
            widget:set_markup(markup.font("Terminus 10", " ") ..
                              markup.font("Terminus 10", "MPD PAUSED") ..
                              markup.font("Terminus 10", " "))
            play_pause_icon:set_text('')
        else
            widget:set_markup("")
...
awful.rules.rules = {
    ...
    { rule = { class = "URxvt" },
          properties = { tag = tags[1][1], opacity = 0.99 } },
